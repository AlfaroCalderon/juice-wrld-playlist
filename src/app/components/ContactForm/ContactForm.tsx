  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 w-full md:w-2/3">
        <div className="flex flex-col justify-center items-center p-2 ">
            <form action="" className="w-full rounded-lg flex flex-col p-4 shadow-amber-500 shadow-xl/30" style={{background:"linear-gradient(159deg,rgba(71, 68, 39, 1) 0%, rgba(224, 187, 63, 1) 100%)"}}>
                <div className="flex flex-col py-2">
                    <label htmlFor="name" className="font-bold">Name:</label>
                    <input className="p-2 bg-white rounded-lg placeholder:text-black mt-2" type="text" name="name" id="name" placeholder="Insert your full name" />
                </div>
                <div className="flex flex-col py-2">
                    <label htmlFor="name" className="font-bold">Lastname:</label>
                    <input className="p-2 bg-white rounded-lg placeholder:text-black mt-2" type="text" name="lastname" id="lastname" placeholder="Insert your full lastname" />
                </div>
                <div className="flex flex-col py-2">
                    <label htmlFor="age" className="font-bold">Age:</label>
                    <input className="p-2 bg-white rounded-lg placeholder:text-black mt-2" type="number" name="age" id="age" placeholder="Insert your age" />
                </div>
                <div className="flex flex-col py-2">
                    <label htmlFor="email" className="font-bold">Email:</label>
                    <input className="p-2 bg-white rounded-lg placeholder:text-black mt-2" type="email" name="email" id="email" placeholder="Insert your email address" />
                </div>
                <div className="flex flex-col py-2">
